...
export function EnrichmentPanel({ config, onSave, onBack }: EnrichmentPanelProps) {
    ...
    return (
        <div>
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Enrichment Settings</h2>
                <p className="text-gray-600">
                    Setup data cleaning rules and API keys for the enrichment process
                </p>
            </div>
